...
import SharingPage from './pages/SharingPage'; // Import the new page
        ...
        <BudgetProvider>
          <Router>
            <Routes>
              ...
              <Route path="/sharing" element={<PrivateRoute><AppLayout><SharingPage /></AppLayout></PrivateRoute>} /> {/* Add the new route */}
